...
namespace JoyReactor.Windows.Views
{
    public class FixedAspectPanel : Panel
    {
        ...
        public static readonly DependencyProperty MaxAspectProperty = DependencyProperty.Register("MaxAspect", typeof(double), typeof(FixedAspectPanel), new PropertyMetadata(0.0));
