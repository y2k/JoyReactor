...
{
	public class OldPostFragment : BaseFragment
	{
		...
		public static OldPostFragment NewFragment (int position)
		{
			return NewFragment<OldPostFragment> (position);
		}

		class PostAdapter : BaseAdapter
		{
			OldPostFragment fragment;

			public PostAdapter (OldPostFragment fragment)
			{
